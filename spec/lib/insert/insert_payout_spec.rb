  ...
  describe '.with_stripe' do
    ...
    context 'when valid' do
      ...
      context 'no charges to payout' do 
        ...
        let!(:ba) do
          ba = InsertBankAccount.with_stripe(nonprofit, user, {stripe_bank_account_token: StripeMockHelper.stripe_helper.generate_bank_token(), name: bank_name})
      ...
      context 'no date provided' do
        ...
        it 'fails properly when Stripe payout call fails' do
          ...
          StripeMockHelper.stripe_helper.prepare_error(Stripe::StripeError.new("Payout failed"), :new_payout)
