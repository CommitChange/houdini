  ...
  describe '.with_stripe' do
    ...
    describe 'exceptions in main function' do
      ...
      it 'Stripe::Account.retrieve fails' do
        ...
        StripeMockHelper.stripe_helper.prepare_error(Stripe::StripeError.new("some error happened"), :get_account )
    ...
    describe 'works with account retrieval' do
      ...
      let(:stripe_bank_account_token) { StripeMockHelper.stripe_helper.generate_bank_token(country: "US", routing_number: "110000000", account_number: "000123456789") }
      ...
      it 'sets failure message when external_account create fails' do
        ...
        StripeMockHelper.stripe_helper.prepare_error(Stripe::StripeError.new("hmm"), :create_external_account)
