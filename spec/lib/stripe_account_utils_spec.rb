...
describe StripeAccountUtils do
  ...
  describe '.create' do
    ...
    it 'uses the redacted nonprofit info' do
      StripeMockHelper.stripe_helper.prepare_error(Stripe::InvalidRequestError.new("things are bad", ''), :new_account)
  ...
  describe 'testing with valid nonprofit' do
    it 'handles Stripe errors properly' do
      StripeMockHelper.stripe_helper.prepare_error(Stripe::StripeError.new, :new_account)
