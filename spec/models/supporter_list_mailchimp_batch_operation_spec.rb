...
RSpec.describe SupporterListMailchimpBatchOperation, :type => :model do
  ...
  context 'when supporter.email is empty' do
    describe '#to_h' do
      it 'returns nil' do
        ...
        operation = SupporterListMailchimpBatchOperation.new(supporter: supporter, list: email_list, method: 'DELETE')
  ...
  context 'when method == POST' do
    describe '#to_h' do 
      it 'has a body key' do
        supporter = build_stubbed(:supporter_base, email:"something@email.com")
        email_list = build_stubbed(:email_list_base)
        operation = SupporterListMailchimpBatchOperation.new(supporter: supporter, list: email_list, method: 'POST')
